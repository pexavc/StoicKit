...
class Kernel {
    ...
    static func dprod(a: [Double], b: [Double]) -> Double {
...
//            vDSP_dotprD(x, 1, y, 1, &sum, vDSP_Length(x.count))
    ...
    {
        var sum = Kernel.dprod(a: problemData.inputs[vector1Index], b: problemData.inputs[vector2Index])
